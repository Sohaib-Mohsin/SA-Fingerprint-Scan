...
public class ScanScreen9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_scan_screen9);
    ...
    protected void onStart() {
        try{
            fingerprint.scan(ScanScreen9.this, printHandler, updateHandler);
        }
        catch(Exception ex){
