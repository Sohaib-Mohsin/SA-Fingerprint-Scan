...
public class ScanScreen2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_scan_screen2);
    ...
    protected void onStart() {
        try{
            fingerprint.scan(ScanScreen2.this, printHandler, updateHandler);
        }
        catch(Exception ex){
