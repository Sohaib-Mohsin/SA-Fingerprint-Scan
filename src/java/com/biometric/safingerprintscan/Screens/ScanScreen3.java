...
public class ScanScreen3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_scan_screen3);
    ...
    protected void onStart() {
        try{
            fingerprint.scan(ScanScreen3.this, printHandler, updateHandler);
        }
        catch(Exception ex){
