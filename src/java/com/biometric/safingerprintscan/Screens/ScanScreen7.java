...
public class ScanScreen7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_scan_screen7);
    ...
    protected void onStart() {
        try{
            fingerprint.scan(ScanScreen7.this, printHandler, updateHandler);
        }
        catch(Exception ex){
