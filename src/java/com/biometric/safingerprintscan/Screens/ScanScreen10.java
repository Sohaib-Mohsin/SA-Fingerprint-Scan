...
public class ScanScreen10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_scan_screen10);
    ...
    protected void onStart() {
        try{
            fingerprint.scan(ScanScreen10.this, printHandler, updateHandler);
        }
        catch(Exception ex){
