...
public class ScanScreen8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_scan_screen8);
    ...
    protected void onStart() {
        try{
            fingerprint.scan(ScanScreen8.this, printHandler, updateHandler);
        }
        catch(Exception ex){
