...
public class ScanScreen5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_scan_screen5);
    ...
    protected void onStart() {
        try{
            fingerprint.scan(ScanScreen5.this, printHandler, updateHandler);
        }
        catch(Exception ex){
